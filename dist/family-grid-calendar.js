...
var S = (n, t, e) => Et(n, typeof t != 'symbol' ? t + '' : t, e);
/**
 * @license
...
let ct = class {
  ...
  get styleSheet() {
    ...
    if (Q && t === void 0) {
      ...
      (s && (t = Y.get(e)),
        t === void 0 &&
          ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), s && Y.set(e, t)));
    }
    return t;
  }
  toString() {
...
const bt = (n) => new ct(typeof n == 'string' ? n : n + '', void 0, X),
  wt = (n, ...t) => {
    const e =
      n.length === 1
        ? n[0]
...
const O = window,
  ...
  ut = (n, t) => t !== n && (t == t || n == n),
  I = { attribute: !0, type: String, converter: q, reflect: !1, hasChanged: ut },
  Z = 'finalized';
let g = class extends HTMLElement {
  ...
  _$EO(t, e, s = I) {
    ...
    if (o !== void 0 && s.reflect === !0) {
      const r = (
        ((i = s.converter) === null || i === void 0 ? void 0 : i.toAttribute) !== void 0
          ? s.converter
          : q
      ...
      const r = i.getPropertyOptions(o),
        l =
          typeof r.converter == 'function'
            ...
            : ((s = r.converter) === null || s === void 0 ? void 0 : s.fromAttribute) !== void 0
              ? r.converter
              : q;
  ...
  requestUpdate(t, e, s) {
    let i = !0;
    (t !== void 0 &&
      (((s = s || this.constructor.getPropertyOptions(t)).hasChanged || ut)(this[t], e)
  ...
  performUpdate() {
    ...
    (this.hasUpdated,
      this._$Ei && (this._$Ei.forEach((i, o) => (this[o] = i)), (this._$Ei = void 0)));
    let e = !1;
    const s = this._$AL;
    try {
...
((g[Z] = !0),
  ...
  st == null || st({ ReactiveElement: g }),
  ((z = O.reactiveElementVersions) !== null && z !== void 0
    ? z
...
const M = window,
  A = M.trustedTypes,
  it = A ? A.createPolicy('lit-html', { createHTML: (n) => n }) : void 0,
  G = '$lit$',
  ...
  m = document,
  k = () => m.createComment(''),
  H = (n) => n === null || (typeof n != 'object' && typeof n != 'function'),
  vt = Array.isArray,
  kt = (n) => vt(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == 'function',
  j = `[ 	
\f\r]`,
  x = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  nt = /-->/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
  ...
  lt = new WeakMap(),
  y = m.createTreeWalker(m, 129, null, !1);
function $t(n, t) {
        ...
        r === x
          ? h[1] === '!--'
            ...
            : h[1] !== void 0
              ? (r = rt)
              : h[2] !== void 0
                ? (_t.test(h[2]) && (i = RegExp('</' + h[2], 'g')), (r = f))
                : h[3] !== void 0 && (r = f)
          : r === f
            ? h[0] === '>'
              ? ((r = i ?? x), (c = -1))
              : h[1] === void 0
                ...
                : ((c = r.lastIndex - h[2].length),
                  (d = h[1]),
                  (r = h[3] === void 0 ? f : h[3] === '"' ? at : ot))
            : r === at || r === ot
              ? (r = f)
              : r === nt || r === rt
                ? (r = x)
                : ((r = f), (i = void 0)));
    const v = r === f && n[l + 1].startsWith('/>') ? ' ' : '';
    o +=
      r === x
        ? a + Ct
        : c >= 0
          ? (s.push(d), a.slice(0, c) + G + a.slice(c) + $ + v)
          : a + $ + (c === -2 ? (s.push(void 0), l) : v);
  }
...
class D {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    const l = t.length - 1,
      a = this.parts,
      [d, h] = Dt(t, e);
    if (((this.el = D.createElement(d, s)), (y.currentNode = this.el.content), e === 2)) {
      ...
      if (i.nodeType === 1) {
        if (i.hasAttributes()) {
          ...
          for (const u of i.getAttributeNames())
            if (u.endsWith(G) || u.startsWith($)) {
              const v = h[r++];
              if ((c.push(u), v !== void 0)) {
                const gt = i.getAttribute(v.toLowerCase() + G).split($),
                  T = /([.?@])?(.*)/.exec(v);
                a.push({
                  type: 1,
                  index: o,
        ...
        if (_t.test(i.tagName)) {
          ...
          if (u > 0) {
            ...
            for (let v = 0; v < u; v++)
              (i.append(c[v], k()), y.nextNode(), a.push({ type: 2, index: ++o }));
            i.append(c[u], k());
          }
        }
      } else if (i.nodeType === 8)
        if (i.data === pt) a.push({ type: 2, index: o });
        else {
          let c = -1;
          for (; (c = i.data.indexOf($, c + 1)) !== -1; )
            (a.push({ type: 7, index: o }), (c += $.length - 1));
        }
      o++;
    }
  }
...
function b(n, t, e = n, s) {
  ...
  return (
    (a == null ? void 0 : a.constructor) !== d &&
      ...
      d === void 0 ? (a = void 0) : ((a = new d(n)), a._$AT(n, e, s)),
      s !== void 0
        ? (((r = (l = e)._$Co) !== null && r !== void 0 ? r : (l._$Co = []))[s] = a)
        : (e._$Cl = a)),
    a !== void 0 && (t = b(n, a._$AS(n, t.values), a, s)),
    t
  );
}
class Pt {
  ...
  u(t) {
    ...
    const {
      ...
      o = ((e = t == null ? void 0 : t.creationScope) !== null && e !== void 0 ? e : m).importNode(
        s,
        !0,
      );
    y.currentNode = o;
    ...
    for (; d !== void 0; ) {
      if (l === d.index) {
        let h;
        (d.type === 2
          ? (h = new P(r, r.nextSibling, this, t))
          : d.type === 1
            ? (h = new d.ctor(r, d.name, d.strings, this, t))
            : d.type === 6 && (h = new Mt(r, this, t)),
          this._$AV.push(h),
          (d = i[++a]));
      }
      l !== (d == null ? void 0 : d.index) && ((r = y.nextNode()), l++);
    }
    return ((y.currentNode = m), o);
  }
  v(t) {
    let e = 0;
...
class P {
  ...
  g(t) {
    ...
    const { values: s, _$litType$: i } = t,
      o =
        typeof i == 'number'
          ? this._$AC(t)
          : (i.el === void 0 && (i.el = D.createElement($t(i.h, i.h[0]), this.options)), i);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === o) this._$AH.v(s);
    else {
      const r = new Pt(o, this),
        l = r.u(this.options);
      (r.v(s), this.$(l), (this._$AH = r));
    }
  }
  _$AC(t) {
  ...
  T(t) {
    ...
    for (const o of t)
      (i === e.length
        ? e.push((s = new P(this.k(k()), this.k(k()), this, this.options)))
        : (s = e[i]),
        s._$AI(o),
        i++);
...
class R {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let r = !1;
    if (o === void 0)
      ((t = b(this, t, e, 0)), (r = !H(t) || (t !== this._$AH && t !== E)), r && (this._$AH = t));
    else {
      const l = t;
      let a, d;
      for (t = o[0], a = 0; a < o.length - 1; a++)
        ((d = b(this, l[s + a], e, a)),
          d === E && (d = this._$AH[a]),
          r || (r = !H(d) || d !== this._$AH[a]),
          d === p ? (t = p) : t !== p && (t += (d ?? '') + o[a + 1]),
          (this._$AH[a] = d));
    }
    r && !i && this.j(t);
  }
...
class Ot extends R {
  ...
  _$AI(t, e = this) {
    var s;
    if ((t = (s = b(this, t, e, 0)) !== null && s !== void 0 ? s : p) === E) return;
    const i = this._$AH,
      o =
        (t === p && i !== p) ||
        t.capture !== i.capture ||
  ...
  handleEvent(t) {
    ...
    typeof this._$AH == 'function'
      ? this._$AH.call(
          (s = (e = this.options) === null || e === void 0 ? void 0 : e.host) !== null &&
            s !== void 0
            ? s
            : this.element,
          t,
...
const dt = M.litHtmlPolyfillSupport;
(dt == null || dt(D, P),
  ((L = M.litHtmlVersions) !== null && L !== void 0 ? L : (M.litHtmlVersions = [])).push('2.8.0'));
const Rt = (n, t, e) => {
  var s, i;
  const o = (s = e == null ? void 0 : e.renderBefore) !== null && s !== void 0 ? s : t;
  let r = o._$litPart$;
  if (r === void 0) {
    const l = (i = e == null ? void 0 : e.renderBefore) !== null && i !== void 0 ? i : null;
    o._$litPart$ = r = new P(t.insertBefore(k(), l), l, void 0, e ?? {});
  }
  return (r._$AI(n), r);
};
/**
...
class C extends g {
  ...
  update(t) {
    ...
    (this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(t),
      (this._$Do = Rt(e, this.renderRoot, this.renderOptions)));
  }
  connectedCallback() {
    var t;
...
((C.finalized = !0),
  (C._$litElement$ = !0),
  (V = globalThis.litElementHydrateSupport) === null ||
    V === void 0 ||
    V.call(globalThis, { LitElement: C }));
const ht = globalThis.litElementPolyfillSupport;
ht == null || ht({ LitElement: C });
((F = globalThis.litElementVersions) !== null && F !== void 0
  ? F
 ...
 */ const Bt = (n) => (t) =>
  typeof t == 'function'
    ? ((e, s) => (customElements.define(e, s), s))(n, t)
    : ((e, s) => {
...
function ft(n) {
  return (t, e) => (e !== void 0 ? It(n, t, e) : zt(n, t));
}
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */ var W;
((W = window.HTMLSlotElement) === null || W === void 0 ? void 0 : W.prototype.assignedElements) !=
  null;
const Lt = (n, t) => new Intl.DateTimeFormat(n.locale.language, { weekday: 'short' }).format(t),
  jt = (n, t) =>
    new Intl.DateTimeFormat(n.locale.language, { day: 'numeric', month: 'short' }).format(t),
  Vt = Array.from({ length: 24 }, (n, t) => `${t.toString().padStart(2, '0')}:00`);
function K(n) {
...
var mt = Object.defineProperty,
  ...
  Kt = (n, t, e) =>
    t in n ? mt(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (n[t] = e),
  B = (n, t, e, s) => {
    for (var i = s > 1 ? void 0 : s ? Wt(t, e) : t, o = n.length - 1, r; o >= 0; o--)
...
let w = class extends C {
  constructor() {
    ...
    S(this, 'hass');
    S(this, '_eventsByDay', {});
    S(this, '_weatherByDay', {});
    S(this, '_timer');
  }
  connectedCallback() {
    (super.connectedCallback(), this._generateMockData());
    const t = Ft * 60 * 1e3;
    this._timer = window.setInterval(() => this._generateMockData(), t);
  }
  disconnectedCallback() {
  ...
  _generateMockData() {
    ...
    for (let i = 0; i < 7; i++) {
      const o = new Date(t);
      o.setDate(t.getDate() + i);
      const r = K(o),
        l = new Date(o);
      l.setHours(9, 0, 0, 0);
      const a = new Date(o);
      a.setHours(10, 30, 0, 0);
      const d = new Date(o);
      d.setHours(9, 30, 0, 0);
      const h = new Date(o);
      h.setHours(12, 0, 0, 0);
      ...
      u.setHours(15, 0, 0, 0);
      const v = [
        { start: l, end: a, title: 'Breakfast', calendar: U[0] },
        { start: d, end: h, title: 'Team Meeting', calendar: U[1] },
        { start: c, end: u, title: 'Study', calendar: U[2] },
      ];
      ((e[r] = this._positionEvents(v)),
        (s[r] = {
          date: r,
          high: 25 + i,
          low: 15 + i,
    ...
    ((this._eventsByDay = e), (this._weatherByDay = s));
  }
  _positionEvents(t) {
    const e = [...t].sort((r, l) => r.start.getTime() - l.start.getTime()),
      s = [],
      i = [];
    for (const r of e) {
      let l = s.findIndex((a) => a <= r.start.getTime());
      (l === -1 ? ((l = s.length), s.push(r.end.getTime())) : (s[l] = r.end.getTime()),
        i.push({ ...r, lane: l, lanes: 0 }));
    }
    const o = s.length || 1;
    return i.map((r) => ({ ...r, lanes: o }));
  }
  _renderTimeAxis() {
    return Vt.map((t) => _`<div>${t}</div>`);
  }
  _renderEvent(t) {
    const e = t.start.getHours() * 60 + t.start.getMinutes(),
      s = t.end.getHours() * 60 + t.end.getMinutes(),
      i = (e / 60) * J,
      o = ((s - e) / 60) * J,
      r = 100 / t.lanes,
      l = t.lane * r;
  ...
  render() {
    ...
    for (let i = 0; i < 7; i++) {
      const o = new Date(s);
      (o.setDate(s.getDate() + i), e.push(o));
    }
    return _`
...
B([ft({ attribute: !1 })], w.prototype, 'hass', 2);
B([yt()], w.prototype, '_eventsByDay', 2);
B([yt()], w.prototype, '_weatherByDay', 2);
w = B([Bt('family-grid-calendar')], w);

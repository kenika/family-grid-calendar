    ...
    >
      ...
      <div class="calendar_container">
        <div class="calendar_header">
          ${this._config.calendars.map(s=>{const o=s.color||"#888",r=this._activeCalendars.has(s.entity),a=r?o:`${o}33`;return v`<button
              style="background:${a};color:${r?"#fff":"#000"}"
        ...
        <div class="weekday_header row">
          ...
          ${e.map(s=>{const o=b(s),r=this._weatherByDay.get(o);return v`<div class="weekday_header_day">
              <div>${Kt(t,s)} ${Gt(t,s)}</div>
              ${r?v`<div class="weather">
                    <ha-icon icon="mdi:weather-${r.cond}"></ha-icon>
                    <span class="high">${r.hi!=null?r.hi.toFixed(0):"--"}</span>
                    <span class="low">${r.lo!=null?r.lo.toFixed(0):"--"}</span>
        ...
        <div class="all_day row">
          <div class="time_axis spacer"></div>
          ${e.map(s=>{const o=b(s),r=(this._allDayEventsByDay[o]??[]).filter(a=>this._activeCalendars.has(a.calendar.entity));return v`<div class="all_day_area">
        ...
        <div class="main row">
          ...
          ${e.map(s=>{const o=b(s),r=(this._eventsByDay[o]??[]).filter(a=>this._activeCalendars.has(a.calendar.entity));return v`<div class="day_columns">

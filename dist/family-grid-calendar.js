 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function O(r){return At({...r,state:!0})}/**
 * @license
    ...
    >
      ...
      <div class="calendar_container">
        ...
        <div class="weekday_header row">
          ...
          ${e.map(s=>{var l,a;const o=K(s),n=this._weatherByDay[o];return v`<div class="weekday_header">
        ...
        <div class="all_day row">
          <div class="time_axis spacer"></div>
          ${e.map(()=>v`<div class="all_day_area"></div>`)}
        </div>
        <div class="main row">
